  ...
  return(
    <div className="div--profile">
      ...
      <div className="task-manager">
        ...
        <div className="relative w-full mx-auto py-14 bg-gradient-to-br from-sky-50 to-gray-200">
            <div className="relative container m-auto px-8 text-gray-500 md:px-12 xl:px-40">
